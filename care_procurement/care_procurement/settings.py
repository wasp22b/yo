...
Resolution order for every key:
    settings.PLUGIN_CONFIGS["care_procurement"][key]  →  environment variable  →  DEFAULTS[key]
...
from care_procurement.apps import PLUGIN_NAME
...
class PluginSettings:  # pragma: no cover
    ...
    >>> from care_procurement.settings import plugin_settings
    >>> plugin_settings.PROCUREMENT_ENABLED
    """
