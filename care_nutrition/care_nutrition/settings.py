...
Resolution order for every key:
    settings.PLUGIN_CONFIGS["care_nutrition"][key]  →  environment variable  →  DEFAULTS[key]
...
from care_nutrition.apps import PLUGIN_NAME
...
class PluginSettings:  # pragma: no cover
    ...
    >>> plugin_settings.NUTRITION_ENABLED
    """
